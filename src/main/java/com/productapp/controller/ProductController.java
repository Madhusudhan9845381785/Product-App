...
//	http://localhost:8080/product-api/v1/products
	...
	ResponseEntity<List<ProductDto>> getAll() {
		...
		ResponseEntity<List<ProductDto>> responseEntity = new ResponseEntity<List<ProductDto>>
									(productDtos, headers, HttpStatusCode.valueOf(200));
...
//	http://localhost:8080/product-api/v1/products/productId/A001
	...
	ResponseEntity<ProductDto> getById(@PathVariable("productId") String productId) {
		...
		HttpHeaders headers = new HttpHeaders();
		headers.add("info", "Getting a product by id " + productId);
...
//	http://localhost:8080/product-api/v1/products/brand/Samsung/price/10000.00
